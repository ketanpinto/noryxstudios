...
const ProjectCard = ({ project }: { project: Project }) => {
    const CardContent = (
        ...
        >
            <div className="relative aspect-[16/10] md:aspect-[16/9] rounded-[2rem] md:rounded-[3rem] overflow-hidden ios-glass shadow-2xl flex items-center justify-center">
        ...
        >
            ...
            <div className="relative z-10 px-4 sm:px-10">
                ...
                <div className="flex justify-center mt-10 md:mt-20">
                    <Link to="/contact" className="group relative px-6 md:px-10 py-3 md:py-5 bg-white text-black rounded-full overflow-hidden transition-all duration-300 hover:pr-14">
                        <span className="relative z-10 font-bold text-xs md:text-sm tracking-[0.2em]">CONTACT US</span>
