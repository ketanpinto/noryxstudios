...
const RevealImage = ({ src, reverse }: { src: string, reverse?: boolean }) => {
  ...
  return (
    <motion.div 
      ...
      className="w-full aspect-[4/3] lg:aspect-square ios-glass rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden shadow-2xl relative"
    >
      <motion.img 
...
export const FeaturesChess: React.FC = () => {
  ...
  const img1 = "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2000&auto=format&fit=crop";
  const img2 = "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2000&auto=format&fit=crop";
